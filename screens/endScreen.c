...
void ecranFin(SDL_Window *window, TTF_Font *font, SDL_Renderer *renderer, SDL_Event event, int *score1, int *score2, int *debutTimer, int *etat, SDL_bool *programON, Mix_Music *musiqueJeu)
{
    int arretEvent = 0;
